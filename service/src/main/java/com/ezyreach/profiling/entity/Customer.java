...
public class Customer {
    ...
    //private JsonAlias address;


    public Customer() {}

    public Customer(String customerId, String name, String gstin, String pan, String udyogAadhaar,
                    String email, String mobile, double turnover) {
